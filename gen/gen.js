/* Générateur de licences Coffre — logique.
...
const LS_VAULT = 'coffregen.vault';
// Partie PUBLIQUE de la clé (pour vérifier que tu colles la bonne clé secrète).
const PUB = { x: 'K0QRUtH_hRpYgDzaPwPFCQB7RBtRazqixOSZWoY2fio', y: 'LSPalK2M97ttTsf6Yxzoifvg6eYgXZFDe3AE0IwiPPk' };
...
el('s-go').addEventListener('click', async () => {
  ...
  if (jwk.x !== PUB.x || jwk.y !== PUB.y || !jwk.d) { err.textContent = "Cette clé ne correspond pas à l'appli Coffre."; return; }
